...
const teamMembers = [
  { image: images1, title: 'WEB DEVELOPER', description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.' },
  { image: images1, title: 'WEB DESIGNER', description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.' },
  { image: images1, title: 'GRAPHIC DESIGNER', description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.' },
  { image: images1, title: 'SEO EXPERT', description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.' },
  { image: images1, title: 'CONTENT WRITER', description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.' },
];
          ...
          >
            {teamMembers.map((member, index) => (
              <SwiperSlide key={index}>
                <div className="bg-white rounded-2xl shadow-lg overflow-hidden text-center transition-transform transform hover:-translate-y-2">
